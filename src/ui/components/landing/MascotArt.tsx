/* The mascot artwork, inlined and split into moving parts.
   ...
   cycling them reads as a shuffle no matter how it is timed. Every polygon below
   is byte-for-byte the geometry of right1.svg, only regrouped, so the hammer can
   pivot in the hand and the boots can alternate.
   ...
   haft, then the boots. Nothing overlaps at rest, so this renders identically to
   the source file; mid-swing it is what lets the head cross in front of the
   torso instead of vanishing behind it, while the fist still reads as gripping
   the handle. */
  ...
  return (
    <>
      <g className="m-core">
        ...
        <path
          className="m-skin"
          d="M172,120h-32v8h-20v52h56v-60h-4ZM168,160v12h-8v-16h8v4ZM140,168v-12h8v16h-8v-4Z"
        />
        <polygon
          className="m-edge"
        ...
        <polygon
          className="m-edge"
          points="176 120 176 124 176 128 176 132 176 136 176 140 176 144 176 148 176 152 176 156 176 160 176 164 176 168 176 172 176 176 176 180 180 180 180 176 180 172 180 168 180 164 180 160 180 156 180 152 180 148 180 144 180 140 180 136 180 132 180 128 180 124 180 120 176 120"
        />
        <polygon
          className="m-edge"
        ...
        <g className="m-hammer">
          ...
          <polygon
            className="m-haft"
            points="104 128 100 128 100 132 100 136 100 140 100 144 100 148 100 152 104 152 104 148 108 148 108 144 108 140 108 136 108 132 108 128 104 128"
          />
          <polygon
            className="m-haft"
        ...
        {/* Last inside the body, so the fist closes over the handle no matter
            where the swing has carried it. */}
        <polygon
          className="m-deep"
