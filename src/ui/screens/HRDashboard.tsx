...
const scoreColor = (s: number) =>
  s >= 70 ? "#16A34A" : s >= 60 ? "#2563EB" : "#D97706"
            ...
            <tbody>
              {jobPosts.map((job, i) => (
                <tr key={i}>
                  ...
                  <td>
                    <span className="fc-badge fc-badge--blue">{job.dept}</span>
                  </td>
                  <td>
                    <div
