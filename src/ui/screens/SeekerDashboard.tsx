...
const recentActivity = [
  {
    ...
    color: "#2563EB",
    text: 'Analyzed "Senior Backend Developer" at VNG Corp',
    time: "2 hours ago",
    score: 78,
  },

  {
    ...
    color: "#16A34A",
    text: "Received 12 AI improvement suggestions for your CV",
    time: "2 hours ago",
  },

  {
    ...
    color: "#D97706",
    text: "Added application to Shopee — Fullstack Engineer",
    time: "1 day ago",
  },

  {
    ...
    color: "#64748B",
    text: "Uploaded new CV version: CV_v3_Backend.pdf",
    time: "3 days ago",
  },
]
    ...
    <div className="fc-stagger">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    ...
                    >
                      +8pts from last month
                    </span>
                    <span className="fc-badge fc-badge--green">
                      <TrendUp size={12} /> Trending
                    </span>
                  </div>
                  <Sparkline
                    points={[55, 58, 61, 60, 66, 69, 73]}
                    color="#2563EB"
                  />
                </div>
              </div>
        ...
        <RevealStagger delay={0.16}>
          <BezelCard>
            ...
            <div style={{ marginTop: 14 }}>
              ...
              >
                <Clock size={13} /> 2 pending review
              </div>
            </div>
          </BezelCard>
        </RevealStagger>
      ...
      <RevealStagger>
        <div
          ...
          style={{
            background:
              "linear-gradient(120deg, #0B1020 0%, #161D33 60%, #1E2742 100%)",
        ...
        >
          <div
            className="fc-glow"
            style={{ width: 280, height: 280, top: -90, right: -40 }}
          />
          <div
            style={{
              width: 52,
          ...
          <div style={{ flex: 1, position: "relative", zIndex: 1 }}>
            ...
            <div style={{ fontSize: 13, color: "rgba(255,255,255,0.7)" }}>
              Based on 847 CVs analyzed in this category this month. Keep
              improving!
            </div>
          </div>
          <button
      ...
      <div
        style={{ display: "grid", gridTemplateColumns: "1fr 322px", gap: 16 }}
      >
        {/* Recent activity */}
        <RevealStagger>
            ...
            >
              ...
              >
                {["Docker", "Kubernetes", "Redis"].map((s) => (
                  <span key={s} className="fc-badge fc-badge--amber">
                    {s}
                  </span>
                ))}
              </div>
