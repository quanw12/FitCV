...
const firstOfCurrentMonth = dateInput(new Date(now.getFullYear(), now.getMonth(), 1))
const lastOfCurrentMonth = dateInput(new Date(now.getFullYear(), now.getMonth() + 1, 0))

const summary: ReportSummary = {
  window: { from: firstOfCurrentMonth, to: lastOfCurrentMonth, label: "Jul 2026" },
  kpis: {
    active_job_posts: 4,
