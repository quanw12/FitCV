...
const emailContent: Record<string, { subject: string body: string[] }> = {
  ...
  shortlist: {
    subject:
      "You've been shortlisted — Senior Backend Developer at TechViet Solutions",
  ...
  interview: {
    subject:
      "Interview Invitation — Senior Backend Developer at TechViet Solutions",
  ...
  const renderBody = (text: string) => {
    ...
    Object.entries(highlights).forEach(([k, v]) => {
      result = result
        .split(k)
        .join(
          `<mark style="background:var(--accent-soft);color:var(--accent-ink);padding:1px 5px;border-radius:5px;font-weight:600;">${v}</mark>`,
        )
    })
          ...
          <div className="fc-card fc-card--pad">
            ...
            {[
              ...
              >
                ...
                <span className="fc-stat__value" style={{ fontSize: 20 }}>
                  {a.value}
                </span>
              </div>
            ))}
          ...
          <div className="fc-card fc-card--pad">
            ...
            >
              <div style={{ display: "flex", gap: 12, marginBottom: 8 }}>
                ...
                >
                  Nguyen Thanh Minh &lt;ntminh@gmail.com&gt;
                </span>
              </div>
