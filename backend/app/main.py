...
from app.api.routes import analyzer, applications, auth, improvements
...
app.include_router(applications.router, prefix="/api/applications", tags=["application-tracker"])
